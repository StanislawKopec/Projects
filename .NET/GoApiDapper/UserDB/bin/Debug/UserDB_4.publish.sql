...
GO
PRINT N'Refreshing Procedure [dbo].[spProductCategories_GetAll]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spProductCategories_GetAll]';


GO
PRINT N'Refreshing Procedure [dbo].[spProducts_Get]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spProducts_Get]';


GO
PRINT N'Refreshing Procedure [dbo].[spProducts_GetAll]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spProducts_GetAll]';


GO
PRINT N'Refreshing Procedure [dbo].[spProducts_GetByCategory]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spProducts_GetByCategory]';
